 ...
 <div class="content sm-gutter">
            <div class="container-fluid padding-25 sm-padding-10">
                <div class="row">
                    ...
                    <h5 class="text-truncate">New Goal</h5>
                </div>
                    </div>
...
<div class="form-row">
  <div class="form-group col-md-12">
   ...
   <input type="text" value="" placeholder="Title" name="goal_title" class="form-control" required="">
...
<div class="new-image" id="image-preview">
  ...
  <input type="file" name="goal_image" id="image-upload" required="" />
</div>
