 ...
 <div class="content sm-gutter">
            <div class="container-fluid padding-25 sm-padding-10">
                <div class="row">
                    ...
                    <h5 class="text-truncate">Edit Equipment</h5>
                </div>
                    </div>
...
<div class="new-image" id="image-preview" style="background: url(../images/<?php echo $equipment['equipment_image'] ?>);background-size: cover; background-position: center;">
  <label for="image-upload" id="image-label">Choose File</label>
  <input type="hidden" value="<?php echo $equipment['equipment_image']; ?>" name="equipment_image_save">
  <input type="file" name="equipment_image" id="image-upload" />
</div>
